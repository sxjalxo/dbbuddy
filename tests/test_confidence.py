...
class TestConfidenceScoring:
    ...
    def test_schema_invalid_downgrades_to_medium(self):
        """Schema validation failure applies a -30 penalty (100 -> 70 = medium)."""
        response = {
            "model_used": "local",
    ...
    def test_execution_error_downgrades_to_medium(self):
        """An execution error applies a -40 penalty (100 -> 60 = medium)."""
        response = {
            "model_used": "local",
            "schema_validation": {"valid": True},
            "auto_fixed": False,
    ...
    def test_nemotron_plus_autofix_is_low(self):
        """Nemotron (-30) + auto-fix (-25) = 45, below the medium threshold."""
        response = {
            "model_used": "nemotron",
            "schema_validation": {"valid": True},
            "auto_fixed": True,
    ...
    def test_confidence_empty_response(self):
        """An empty response is handled gracefully (returns a valid level)."""
        response = {}
    ...
    def test_confidence_nemotron_with_auto_fixed(self):
        """Nemotron (-30) with auto-fix (-25) lands at 45 = low."""
        response = {
            "model_used": "nemotron",
            "schema_validation": {"valid": True},
            "auto_fixed": True,
